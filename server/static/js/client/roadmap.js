layui.use(['jquery', 'layer', 'form', 'laytpl'], function(){
    ...
    function getCurrentThemeColors() {
        return document.body.classList.contains('dark-mode') ? 
            colorOptions.dark : colorOptions.light;
    }
        ...
        $('.task-card').each(function() {
            ...
            for (const [className, lightColor] of Object.entries(lightColors)) {
                ...
                if (currentColor === lightRGB || currentColor === darkRGB) {
                    ...
                    $card.css('background-color', newColor)
                         .css('border-left-color', newColor);
                    break;
                }
            }
        });
    ...
    function initTheme() {
        ...
        if (isDarkMode) {
            ...
            $('#themeSwitch .layui-icon')
                .removeClass('layui-icon-sunny')
                .addClass('layui-icon-moon');
    ...
    function toggleTheme() {
        ...
        if (isDarkMode) {
            $icon.removeClass('layui-icon-sunny').addClass('layui-icon-moon');
        } else {
            $icon.removeClass('layui-icon-moon').addClass('layui-icon-sunny');
        }
            ...
            success: function(layero) {
                ...
                $colorOptions.on('click', '.color-option', function() {
                    ...
                    $colorOptions.find('.color-option').removeClass('selected')
                        .find('.layui-icon').remove();
                    $this.addClass('selected')
                        .append('<i class="layui-icon layui-icon-ok"></i>');
                });
