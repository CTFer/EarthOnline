layui.use(["layer", "form", "element"], function () {
        ...
        .map(
          (player) => `
                <tr>
                    ...
                    <td>
                        <button class="layui-btn layui-btn-sm" onclick="editPlayer(${player.id})">编辑</button>
                        <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="deletePlayer(${player.id})">删除</button>
                    </td>
                </tr>
            `
        )
  ...
  window.editTask = function (id) {
    fetch(`/admin/api/tasks/${id}`)
      .then((response) => response.json())
      .then((task) => {
        $('input[name="name"]').val(task.data.name);
        $('textarea[name="description"]').val(task.data.description);
        $('input[name="exp_reward"]').val(task.data.exp_reward);
        $('input[name="gold_reward"]').val(task.data.gold_reward);
