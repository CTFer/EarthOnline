...
(function () {
    ...
    Build.prototype.draw = function () {
        ...
        for (var i = 0; i < this.varr.length; i++) {
            ...
            var g = this.$.createRadialGradient(this.varr[i].transOut.x, this.varr[i].transOut.y, this
                .varr[i].transOut.p, this.varr[i].transOut.x, this.varr[i].transOut.y, this.varr[i]
                .transOut.p * 2);
